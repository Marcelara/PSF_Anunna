...
The Ernakovich lab has made very elaborate slurm scripts that contains a lot of interesting information. You can reed this once. After that, you can reduce the script to the following essential elements.

```{bash eval=F, echo=T, error=T}
#!/bin/bash -login 	            ### -login is essential to be able to activate conda environment
...
#SBATCH --output=00_setup_dada2_%j.output ### name of the output file (same as -o)
