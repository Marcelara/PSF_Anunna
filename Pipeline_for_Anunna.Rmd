...
Okay, finally we can start with running the pipeline. Keep in mind that you will encounter some errors on the way, and that it may take hours to find a solution every. But to give you some mental support, you will get to the end!
...
Before running the slurm script, check in the slurm script and the corresponding R scipt whether the file paths are correct. Yoiu can use nano to change the paths when this is not the case.
