...
data.fp <- "/lustre/nobackup/INDIVIDUAL/arago004/ernakovichlab_pipeline/Marcela_samples_16S" 
...
map.fp <- file.path(data.fp, "Mapping_file_16S_Family_experiment.txt") 
...
project.fp <- "/lustre/nobackup/INDIVIDUAL/arago004/ernakovichlab_pipeline/16S_processed_MA" # CHANGE ME to project directory; don't append with a "/"
