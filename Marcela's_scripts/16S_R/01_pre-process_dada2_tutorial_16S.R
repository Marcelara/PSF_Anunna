...
fnFs <- sort(list.files(data.fp, pattern="_R1.fastq.gz", full.names = TRUE))
fnRs <- sort(list.files(data.fp, pattern="_R2.fastq.gz", full.names = TRUE))
...
#[3:49 PM] Beschoren da Costa, Pedro
# Set up the primer sequences to pass along to cutadapt
FWD <- "CCTACGGGNGGCWGCAG"## CHANGE ME # this is 341f
REV <- "GACTACHVGGGTATCTAATCC"## CHANGE ME # this is 805r
# FWD <- "CTTGGTCATTTAGAGGAAGTAA"## CHANGE ME # this is ITS1F
# REV <- "GCTGCGTTCTTCATCGATGC"## CHANGE ME # this is ITS2
...
# Run Cutadapt
#[3:53 PM] Beschoren da Costa, Pedro
# Run Cutadapt
