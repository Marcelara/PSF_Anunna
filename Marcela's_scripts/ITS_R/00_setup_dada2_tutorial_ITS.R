...
data.fp <- "/lustre/nobackup/INDIVIDUAL/arago004/ernakovichlab_pipeline/Marcela_samples_ITS" 
...
map.fp <- file.path(data.fp, "Mapping_file_ITS_Family_experiment.txt") 
...
project.fp <- "/lustre/nobackup/INDIVIDUAL/arago004/ernakovichlab_pipeline/ITS_processed_MA" # CHANGE ME to project directory; don't append with a "/"
