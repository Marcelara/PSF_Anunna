...
# Assign taxonomy
tax <- assignTaxonomy(seqtab.nochim, "/lustre/nobackup/INDIVIDUAL/kreek001/dada2_ernakovichlab-main/taxonomy_files/silva_nr99_v138.1_train_set.fa", tryRC = TRUE,
                      multithread=TRUE)
