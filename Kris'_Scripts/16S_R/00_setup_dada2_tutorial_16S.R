...
data.fp <- "/lustre/nobackup/INDIVIDUAL/kreek001/Pilot3_raw_reads/16S"
...
project.fp <- "/lustre/nobackup/INDIVIDUAL/kreek001/Pilot3_output_slurm_16S" # CHANGE ME to project directory; don't append with a "/"
